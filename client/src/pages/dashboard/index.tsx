...
class Dashboard extends Component<IProps> {
    ...
    handleFileIPFS = async (fileReaderResult: any) => {
    ...
    handleFileBlockchain = async (fileIPFS: any, fileName: any, fileType: any) => {
    ...
    // onFileDrop = useCallback((acceptedFiles: Blob[]) => {
    ...
    //             const fileIPFS = await this.handleFileIPFS(filereader.result);
    //             this.handleFileBlockchain(fileIPFS.path, file.name, file.type);
    //         };
    //     })
    // }, []);
                                    ...
                                    <Grid item xs={12} sm={12}>
                                        ...
                                        <div className="dropzone">
                                            <Dropzone
                                                ...
                                                onFileDialogCancel={this.onFileCancel.bind(this)}
                                            >
